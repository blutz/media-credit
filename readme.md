...
## Just trying to install the plugin? Read the [wiki](https://github.com/blutz/media-credit/wiki)

## Description

*This plugin has been modified by [Byron Lutz](mailto:byronlutz@gmail.com) to work with WordPress 3.5. I bumped the version number and made some significant structural changes so this plugin is not directly compatible with Scott's versions (for more see the [wiki](https://github.com/blutz/media-credit/wiki) on GitHub).*

**Upgrade instructions are on the [wiki](https://github.com/blutz/media-credit/wiki).**
...
Since this plugin is not on the WordPress.org plugin repository you must do a manual install:

1. [Download the contents of this repository](https://github.com/blutz/media-credit/archive/master.zip)
1. Extract the contents of the zip file into your /wp-content/plugins/ directory
1. Activate the plugin through the 'Plugins' menu in WordPress
1. Make the proper modification to your WordPress install (see the wiki)
1. Party.

## Frequently Asked Questions

### I'm seeing `[media-credit ...]` instead of the credit. What do I do?
You should see the shortcode in the visual editor but not on the front-end of your site. See the [wiki](https://github.com/blutz/media-credit/wiki) for a fix to this.
